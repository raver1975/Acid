...
//     }
   ...
   public void controlChange(int controller, int value)
   {
     switch (controller) {
     case 34:
       this.cutoff.setValue(value / 127.0D * 4800.0D + 200.0D);
       break;
     case 35:
       this.resonance.setValue(value / 127.0D);
       break;
     case 36:
       this.envMod = (value / 127.0D);
       break;
     case 33:
       double tmp = value / 127.0F * 2.0F - 1.0F;
       this.tune = Math.pow(2.0D, tmp);
       this.osc.setFrequency(this.frequency * this.tune);
       break;
     case 37:
       double tmp2 = 1.0D - value / 127.0D;
       this.decay = (tmp2 * 19.875D + 0.125D);
       this.feg.setDecay(this.decay);
