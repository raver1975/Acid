...
public class Sound implements ApplicationListener, InputProcessor {
	...
	public void render() {
		...
		y += 20;
		drawSolidPolygon(0, (y), (int) (Sound.output.getSequencer().bpm
		...
		font.draw(
				batch,
				"Tempo "
						+ value(Double.toString((Sound.output.getSequencer().bpm)))
						+ "", 5, 160);
		// font.draw(batch,
	...
	public boolean touchDown(int x, int y, int pointer, int button) {
		...
		if (y > Gdx.graphics.getHeight() - 15) {
			...
			Sound.output.getSequencer().setBpm(
